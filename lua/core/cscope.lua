...
if io.open("cscope.out", "r") ~= nil then
	...
	if not ok then
		...
		vim.api.nvim_set_keymap(
			"n",
			"<leader>cs",
			[[<cmd>lua cscope_search('s', vim.fn.expand("<cword>"))<cr><cr>]],
			opts
		)
		vim.api.nvim_set_keymap(
			"n",
			"<leader>cg",
			[[<cmd>lua cscope_search('g', vim.fn.expand("<cword>"))<cr><cr>]],
			opts
		)
		vim.api.nvim_set_keymap(
			"n",
			"<leader>cc",
			[[<cmd>lua cscope_search('c', vim.fn.expand("<cword>"))<cr><cr>]],
			opts
		)
		vim.api.nvim_set_keymap(
			"n",
			"<leader>ct",
			[[<cmd>lua cscope_search('t', vim.fn.expand("<cword>"))<cr><cr>]],
			opts
		)
		vim.api.nvim_set_keymap(
			"n",
			"<leader>ce",
			[[<cmd>lua cscope_search('e', vim.fn.expand("<cword>"))<cr><cr>]],
			opts
		)
		vim.api.nvim_set_keymap(
			"n",
			"<leader>cf",
			[[<cmd>lua cscope_search('f', vim.fn.expand("<cfile>"))<cr><cr>]],
			opts
		)
		vim.api.nvim_set_keymap(
			"n",
			"<leader>ci",
			[[<cmd>lua cscope_search('i', vim.fn.expand("<cfile>"))<cr><cr>]],
			opts
		)
		vim.api.nvim_set_keymap(
			"n",
			"<leader>cd",
			[[<cmd>lua cscope_search('d', vim.fn.expand("<cword>"))<cr><cr>]],
			opts
		)
		vim.api.nvim_set_keymap(
			"n",
			"<leader>ca",
			[[<cmd>lua cscope_search('a', vim.fn.expand("<cword>"))<cr><cr>]],
			opts
		)
	else
		-- which-key mappings
